...
Quick reference for all MaestroNexus MCP tools, resources, and the knowledge graph schema.
...
| Task                                         | Skill to read       |
| -------------------------------------------- | ------------------- |
| Understand architecture / "How does X work?" | `maestronexus-exploring`         |
| Blast radius / "What breaks if I change X?"  | `maestronexus-impact-analysis`   |
| Trace bugs / "Why is X failing?"             | `maestronexus-debugging`         |
| Rename / extract / split / refactor          | `maestronexus-refactoring`       |
| Tools, resources, schema reference           | `maestronexus-guide` (this file) |
| Index, status, clean, wiki CLI commands      | `maestronexus-cli`               |
