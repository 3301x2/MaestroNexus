...
program
  .name('maestronexus')
  .description('MaestroNexus local CLI and MCP server')
  .version('1.2.0');
...
program
  .command('clean')
  .description('Delete MaestroNexus index for current repo')
...
program
  ...
  .option('--api-key <key>', 'LLM API key (saved to ~/.maestronexus/config.json)')
