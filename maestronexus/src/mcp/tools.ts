 ...
 * 
 * Defines the tools that MaestroNexus exposes to external AI agents.
...
export const MAESTRONEXUS_TOOLS: ToolDefinition[] = [
  {
    name: 'list_repos',
    description: `List all indexed repositories available to MaestroNexus.

Returns each repo's name, path, indexed date, last commit, and stats.

WHEN TO USE: First step when multiple repos are indexed, or to discover available repos.
AFTER THIS: READ maestronexus://repo/{name}/context for the repo you want to work with.
...
WHEN TO USE: Complex structural queries that search/explore can't answer. READ maestronexus://repo/{name}/schema first for the full schema.
...
AFTER THIS: Use impact() if planning changes, or READ maestronexus://repo/{name}/process/{processName} for full execution trace.
...
AFTER THIS: Review affected processes. Use context() on high-risk symbols. READ maestronexus://repo/{name}/process/{name} for full traces.
